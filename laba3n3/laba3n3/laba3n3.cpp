...
// Вычислить значение функции y = f(x) при произвольных х 
// Продемонстрировать работоспособность написанной программы минимум для трёх разных значений, при а = 0.004 и b = 42
